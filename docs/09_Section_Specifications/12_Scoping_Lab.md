...
5. **Region-Aware Dynamic Pricing Engine**:
   - Pricing logic resides strictly in [`src/lib/pricing.ts`](../../src/lib/pricing.ts).
...
- [SOTA Scoping & E-Commerce Cart PRD](../25_SOTA_Scoping_Engine_PRD.md)
- [Client Workspace Dashboard](13_Client_Workspace_Dashboard.md)
- [Razorpay 50% Deposit System](../14_Razorpay_Payments_and_Invoicing.md)
- [Unified Master Roadmap (Phase G)](../UNIFIED_MASTER_ROADMAP.md)
- [Architecture Node: Route /scoping](../architecture_nodes/Route_scoping.md)
- [Architecture Node: Scoping Lab UI](../architecture_nodes/UI_ScopingLab.md)