...
def validate_project_response(data):
    ...
    return {
        ...
        "systemRole": optional_string(data, "systemRole", max_len=100),
        "telemetryBadge": optional_string(data, "telemetryBadge", max_len=100),
        "ctaLabel": optional_string(data, "ctaLabel", max_len=100),
