...
export const projects: Project[] = [
  {
    ...
    description: 'A scenario-driven simulation game where players guide a planet through ten evolutionary eras by making high-stakes decisions.',
    longDescription: 'Earth Evolution Simulator is a scenario-driven simulation game where players guide a planet through ten distinct evolutionary eras. By resolving high-stakes ecological and geological decisions, players navigate random events and path-dependent consequences to steer the planet toward one of four cosmic endings. The Python Flask backend maintains game state in-session and records player run telemetry into a local SQLite database, while a custom game engine models planetary habitability by tracking dynamic variables and applying a deferred trigger system (',
  ...
  },
  {
    ...
    description: 'A real-time International Space Station tracker displaying reverse-geocoded terrestrial location or nearest ocean/landmass.',
  ...
  },
  {
    id: 'metawipe',
    title: 'MetaWipe',
    description: 'A privacy-first mobile app that strips metadata (EXIF, GPS, device data) from photos locally before sharing.',
  ...
  {
    id: 'prateeksync-ai--intelligent-portfolio---resume-automation-engine',
    title: 'PrateekSync AI: Intelligent Portfolio & Resume Automation Engine',
    description: 'An AI-powered local orchestrator and headless CMS that automates portfolio metadata, verifies scanned credentials via multimodal OCR, and dynamically syncs archetype-tailored resume metrics.',
    longDescription: 'PrateekSync AI is engineered as a robust headless CMS, leveraging Python 3.x and Streamlit for its interactive dashboard, to intelligently manage and synchronize professional portfolio and resume data. It features a custom Python state machine parser for safe, direct manipulation of TypeScript data files without AST corruption, ensuring integrity for dynamic content generation. Core functionalities include a Google Gemini 2.5 Flash API-driven repository analyzer that synthesizes GitHub commit data into tailored resume bullets, alongside a multimodal OCR system for verifying credentials from image or PDF scans. The architecture integrates robust file system operations for asset management and supports diverse content generation tasks, from technical blogs to interactive skill dependency mapping, offering a comprehensive, AI-enhanced content automation solution.',
    image: '/images/project-prateeksync-ai--intelligent-portfolio---resume-automation-engine.webp',
    tags: ['Python', 'Google Gemini', 'Streamlit', 'GitHub API', 'TypeScript', 'Next.js'],
    liveUrl: '',
    githubUrl: '',
    color: '#2979FF',
    isLive: false,
