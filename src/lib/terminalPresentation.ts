...
export const TERMINAL_PITCH_LINES: ConsoleLine[] = [
  ...
  { text: '      Backed by 330+ automated unit, integration, and contract tests (Vitest + Pytest)', type: 'output' },
  ...
  { text: '  • Type "tests"          - Inspect the 330+ automated test suite breakdown', type: 'link', command: 'tests' },
...
export const TERMINAL_TEST_SUITE_LINES: ConsoleLine[] = [
  ...
  { text: '   "330+ passing tests across 42 test suites with 100% contract synchronization."', type: 'output' },
  { text: '================================================================================', type: 'success' },
  { text: ' ', type: 'output' },
  ...
  if (state.step === 'role_select' && (trimmed === '1' || trimmed.includes('tech') || trimmed.includes('cto'))) {
    return {
      ...
      lines: [
        ...
        { text: '  • Automated Testing: 330+ passing tests across 42 test suites (Vitest + Pytest).', type: 'output' },
